      ...
      <div className="p-2 flex flex-col pb-0 flex-grow pr-0 gap-1">
        ...
        <div className="flex flex-wrap gap-1">
          {bot.categories.map((it, key) => (
            <span
              key={key}
              className="rounded-md bg-gray-500 text-white py-1 px-3 whitespace-nowrap"
            >
        ...
        <div className="flex w-full">
          {bot.invite ? (
            ...
            <Tippy content="봇 초대 링크를 가져올 수 없습니다. 잠금 처리된 봇일 수 있습니다">
              <a
                href={bot.invite}
                className="cursor-default p-3 w-1/2 text-center hover:bg-blue-400 hover:text-white transition-colors whitespace-nowrap"
              >
                초대하기
              </a>
            </Tippy>
